  ...
  try {
    ...
    dispatch({
      ...
      payload:
        error.response?.data?.message ||
        error.message ||
        "An error occurred while adding timeline",
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload:
        error.response?.data?.message ||
        error.message ||
        "An error occurred while deleting timeline",
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload:
        error.response?.data?.message ||
        error.message ||
        "An error occurred while adding youtube",
    });
  }
};
  ...
  try {
    ...
    dispatch({
      ...
      payload:
        error.response?.data?.message ||
        error.message ||
        "An error occurred while deleting youtube",
    });
  }
};
